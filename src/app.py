# src/app.py
# ─────────────────────────────────────────────────────────────────────────────
#  CYBERKIDZSEC ⚡ VAULT — Modular App Factory
# ─────────────────────────────────────────────────────────────────────────────
...
from src.blueprints.copilot import copilot  # ✅ FIXED: use full import path
...
def create_app():
    ...
    # Auto-import models for migrations
...
def register_blueprints(app):
    ...
    app.register_blueprint(status)  # Healthcheck
