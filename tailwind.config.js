  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        warpBlur: {
          '0%,100%': { transform: 'scale(1) translate(0)', opacity: '0.88' },
          '50%': { transform: 'scale(1.1) translate(-10px,-10px)', opacity: '0.98' },
        },
        shimmer: {
